    ...
    <section class="bg-gray-100">
        <div class="container mx-auto py-12 flex items-center flex-wrap">
          <div
            ...
            :style="{borderRadius: '45% 55% 64% 36% / 56% 51% 49% 44%'}"
          >
            <img
              src="~/assets/images/Latte.jpg"
              alt="Watthana Peerajing"
              class="absolute w-full h-full object-cover"
            />
          </div>
          <div>
            <h1 class="text-2xl font-bold">Hi, I am Latte</h1>
      ...
      <div class="container py-10">
        <div class="grid sm:grid-cols-3 gap-10">
          ...
          <!-- <BlogGrid
            ...
            excerpt="Never Too Young for Fun Something about the stuffed animal we dubbed “crinkle puppy” for its crinkly sound when squeezed left my daughter Emma, 3 months at the time, smiling each time I placed it in front of her. Maybe it was the contrasting colors that held Emma’s attention. It could have been the way I often “spoke” for the puppy, giving Emma an idea of what a real puppy would sound"
